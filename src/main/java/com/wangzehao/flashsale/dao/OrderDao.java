...
public interface OrderDao {
    ...
    @Select("select * from sale_order where user_id=#{userNickName} and goods_id=#{goodsId}")
    public SaleOrder getSaleOrderByUserIdGoodsId(@Param("userNickName") long userNickName, @Param("goodsId") long goodsId);
